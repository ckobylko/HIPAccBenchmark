...
public: \
  ...
  {\
    ...
    \
    LAUNCH_HANDLER_VECTORIZED( ##__IS_Name##::ccNormGradUInt8_##__IS_Name##filterKernel, spOutputImage1, spOutputImage2, spInputImage1, spInputImage2, ciStrideOutput, ciStrideInput1, ciStrideInput2 ); \
  }\
};
