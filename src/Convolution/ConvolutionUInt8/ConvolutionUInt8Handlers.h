#ifndef _CONVOLUTION_UINT8_HANDLERS_H_
#define _CONVOLUTION_UINT8_HANDLERS_H_
...
public: \
  ...
  {\
    ...
    \
    LAUNCH_HANDLER_VECTORIZED( ##__IS_Name##::ccConvUInt8_##__IS_Name##filterKernel, spOutputImage, spInputImage, ciStrideOutput, ciStrideInput, ciAnchor ); \
  }\
};
...
#endif // _CONVOLUTION_UINT8_HANDLERS_H_
