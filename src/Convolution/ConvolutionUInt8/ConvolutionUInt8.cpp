...
void Convolution::_RunUInt8(unsigned int uiKernelSize)
{
  ...
  AppendHandlerList( lstHandlers, ConvolutionUInt8_GetScalarHandlers() );
  AppendHandlerList( lstHandlers, ConvolutionUInt8_GetSSEHandlers()    );
  AppendHandlerList( lstHandlers, ConvolutionUInt8_GetAVXHandlers()    );
  ...
  CONVOLUTION_CHECK_OUTPUT( UInt8 );
