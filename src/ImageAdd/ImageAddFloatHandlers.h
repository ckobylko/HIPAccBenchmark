...
#include "HIPAccSources/AddFloatDefines.h"
#include <list>
#include <memory>
#include <string>
#include <type_traits>
...
public:
  ...
  {
    static_assert( std::is_base_of< ImageAddFloatHandler, HandlerType >::value, "The handler type must be derived from HipaccHandler!");
