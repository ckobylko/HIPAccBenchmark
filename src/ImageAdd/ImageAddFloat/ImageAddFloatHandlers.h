#ifndef _IMAGE_ADD_FLOAT_HANDLERS_H_
#define _IMAGE_ADD_FLOAT_HANDLERS_H_
...
public: \
  ...
  {\
    ...
    \
    LAUNCH_HANDLER_VECTORIZED( ##__IS_Name##::ccAddFloat_##__IS_Name##filterKernel, spOutputImage, spInputImage1, spInputImage2, ciStrideOutput, ciStrideInput1, ciStrideInput2 ); \
  }\
};
...
#endif // _IMAGE_ADD_FLOAT_HANDLERS_H_
