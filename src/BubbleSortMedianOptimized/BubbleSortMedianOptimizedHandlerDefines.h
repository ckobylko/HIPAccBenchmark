#ifndef _BUBBLE_SORT_MEDIAN_OPTIMIZED_HANDLER_DEFINES_H_
#define _BUBBLE_SORT_MEDIAN_OPTIMIZED_HANDLER_DEFINES_H_
...
#endif // _BUBBLE_SORT_MEDIAN_OPTIMIZED_HANDLER_DEFINES_H_
