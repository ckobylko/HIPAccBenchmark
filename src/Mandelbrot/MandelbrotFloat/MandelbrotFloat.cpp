...
void Mandelbrot::_RunFloat()
{
  ...
  AppendHandlerList( lstHandlers, MandelbrotFloat_GetScalarHandlers() );
  AppendHandlerList( lstHandlers, MandelbrotFloat_GetSSEHandlers()    );
  AppendHandlerList( lstHandlers, MandelbrotFloat_GetAVXHandlers()    );
